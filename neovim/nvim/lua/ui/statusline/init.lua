local c = require("ui.statusline.components")
local colors = c.colors

local normal_hl = vim.api.nvim_get_hl(0, { name = "Normal" })
local statusline_hl = vim.api.nvim_get_hl(0, { name = "StatusLine" })
local fg_lighten = normal_hl.bg and tools.darken(string.format("#%06x", normal_hl.bg), 0.6) or colors.stealth
